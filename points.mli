...
(* Class point --
   Arguments: x0 : float     initial x coordiante of the point
...
class point : float -> float -> object
    ...
    (* Returns the position of the point with coordiantes rounded to
       the nearest int *)
    method round : int * int

    (* Moves the point destructively by changing the point's coordinates *)
